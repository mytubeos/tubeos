...
const buildCsv = (rows, channelName, period) => {
  ...
  // Metadata header
  lines.push(`# Vezrin Analytics Report`);
...
const buildPdf = (rows, channelName, period) => {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .font('Helvetica-Bold')
      .fontSize(20)
      .text('Vezrin Analytics Report', 65, 45);
    doc
      .fillColor('#C7D2FE')
      .font('Helvetica')
      .fontSize(10)
    ...
    doc
      ...
      .font('Helvetica')
      .fontSize(8)
      .text('Generated by Vezrin • tubeos.saas@gmail.com', 50, footerY, {
        align: 'center',
        width: W,
      });
...
const buildReportPdf = (reportData, user) => {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .fontSize(8)
      .text(
        `Generated by Vezrin  •  ${new Date().toDateString()}  •  ${user?.email || ''}`,
        50,
        footerY,
